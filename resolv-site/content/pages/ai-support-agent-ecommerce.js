export const page = {
  ...
  seo: {
    title: 'AI Support Agent for Ecommerce | Resolv',
    description:
  ...
  hero: {
    ...
    sub: 'Post-purchase questions — order status, refunds, exchanges, cancellations — are the bulk of ecommerce support. Resolv resolves them automatically and keeps financial actions under your approval.',
  },
  problem: {
    id: 'problem',
    eyebrow: 'The problem',
  ...
  solution: {
    ...
    paragraphs: [
      'Resolv is built specifically around the post-purchase questions ecommerce brands get every day. It reads the order, understands what the customer is asking, and drafts (or stages) the correct response.',
  ...
  steps: {
    ...
    steps: [
      { num: '01', title: 'Email arrives', body: 'Resolv classifies the request and matches it to the customer\'s order automatically.' },
  ...
  faqs: [
    { q: 'How is this different from a live chat widget?', a: 'Resolv works inside your email inbox, where most ecommerce support actually happens, rather than only inside an on-site chat widget.' },
    ...
    { q: 'What ecommerce platforms does this work with?', a: 'Resolv is built Shopify-first. [Requires validation] for other ecommerce platforms.' },
  ],
  relatedLinks: [
