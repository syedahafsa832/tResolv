export const page = {
  ...
  whoFor: {
    left: {
      title: 'Zendesk tends to fit',
      items: [
        'Large or enterprise support organizations with complex, multi-channel needs',
        'Teams that need extensive customization and third-party integrations across many departments',
        'Organizations outside of Shopify-first ecommerce',
      ],
    },
    right: {
      ...
      items: [
        ...
        'Brands that want to keep using Gmail rather than migrate to a new platform',
      ],
    },
  },
  whenBetter: {
