...
export const posts = [
  {
    ...
    blocks: [
      { type: 'h2', id: 'what-it-does', text: 'What does an AI customer support agent do?' },
      ...
      { type: 'h2', id: 'agent-vs-chatbot', text: 'How is an AI customer support agent different from a chatbot?' },
      ...
      { type: 'h3', id: 'what-stays-with-humans', text: 'What should an AI support agent leave to a human?' },
...

  {
    ...
    intro: 'The short answer: a chatbot matches what a customer types to pre-written responses, while an AI support agent interprets open-ended requests, checks live data such as an order\'s status, and can stage actions like a refund for human approval. The difference matters most in ecommerce, where most questions depend on order data.',
    blocks: [
      { type: 'h2', id: 'chatbot-definition', text: 'What is a support chatbot built to do?' },
      ...
      { type: 'h2', id: 'agent-definition', text: 'What is an AI support agent built to do?' },
      ...
      { type: 'h2', id: 'key-differences', text: 'What are the key differences between an AI agent and a chatbot?' },
      { type: 'ul', items: [
      ...
      { type: 'h2', id: 'which-for-ecommerce', text: 'Which does ecommerce support need: an AI agent or a chatbot?' },
...

  {
    ...
    intro: 'Shopify stores automate customer support by connecting their support inbox to their store data, classifying each incoming request, checking the real order, and drafting or staging the reply, with refunds and cancellations kept behind human approval. Order status, refunds, cancellations, and address changes make up the bulk of the inbox, which is why this pattern automates well.',
    blocks: [
      { type: 'h2', id: 'the-pattern', text: 'Which Shopify support tickets can be automated?' },
      ...
      { type: 'h3', id: 'staged-actions', text: 'Should refunds and cancellations be automated?' },
      ...
      { type: 'h2', id: 'measuring-it', text: 'How do you know if support automation is working?' },
...

  {
    ...
    intro: 'The best AI customer support tool for a Shopify brand is one that connects to the inbox you already use, checks live Shopify order data before replying, stages refunds and cancellations for human approval, and reports resolution rates you can verify. This guide walks through those four criteria rather than offering a generic ranked list.',
    blocks: [
      { type: 'h2', id: 'what-to-evaluate', text: 'What should you evaluate in an AI customer support tool?' },
      ...
      { type: 'h3', id: 'trial-first', text: 'Should you trial an AI support tool before committing?' },
...

  {
    ...
    intro: 'You can reduce ecommerce support tickets by preventing them with proactive shipping communication, deflecting them with clear policy pages, and resolving the rest automatically with an AI agent that checks live order data while keeping refunds under human approval. The goal is not ignoring customers; it is resolving repetitive requests before they need a human, and answering the rest faster.',
    blocks: [
      { type: 'h2', id: 'why-volume-grows', text: 'Why does ecommerce support volume grow faster than headcount?' },
      ...
      { type: 'h2', id: 'where-is-my-refund', text: '"Where is my refund?" is its own ticket type' },
      { type: 'p', text: 'Refund requests actually split into two different questions. The first is "can I get a refund", a policy decision that depends on your return window and the specifics of the order. The second is "where is my refund", a status question from someone whose refund is already approved or in progress. That second question is pure repetition: the customer isn\'t asking you to decide anything, they just want to know where things stand.' },
      { type: 'p', text: 'A status question like that can be answered automatically the same way an order-tracking question can, by checking the refund\'s current state in Shopify and replying with what\'s actually true. What shouldn\'t be automatic is the decision behind it, whether to approve the refund, for how much, under which policy exception. That part stays with a person.' },
      { type: 'p', text: 'tResolv keeps those two things separate on purpose: it can tell a customer exactly where their refund stands the moment they ask, while the refund itself still waits in your approval queue until you tap approve.' },
...

  {
    ...
    blocks: [
      { type: 'h2', id: 'what-automation-means-here', text: 'What does AI automation mean for Shopify customer support?' },
      ...
      { type: 'h2', id: 'knowledge-grounding', text: 'Grounding replies in what your store actually says' },
      { type: 'p', text: 'Beyond order data, a working system imports your store\'s products, policies, and pages so replies about sizing, shipping, and returns match what your store actually says, rather than a generic script the AI improvises.' },
      ...
      { type: 'h2', id: 'getting-started', text: 'How do you get started with AI support automation?' },
