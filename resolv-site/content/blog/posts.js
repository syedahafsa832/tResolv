...
export const posts = [
  {
    ...
    blocks: [
      ...
      { type: 'h2', id: 'resolv-approach', text: 'How Resolv approaches this' },
      { type: 'p', text: 'Resolv is built specifically as an AI customer support employee for Shopify brands: it reads your Gmail inbox, checks the live Shopify order before replying, and stages any refund, cancellation, or address change for your one-tap approval rather than executing it automatically.' },
    ],
    faqs: [
      ...
      { q: 'Can an AI agent handle refunds on its own?', a: 'It depends on the tool. Resolv checks refund eligibility and drafts the response, but stages the actual refund for a human\'s approval rather than executing it automatically.' },
...

  {
    ...
    faqs: [
      { q: 'Do I need developer help to automate Shopify support?', a: 'Tools built specifically for this, like Resolv, are designed for a no-code setup — connecting Gmail and Shopify typically takes under 10 minutes.' },
...

  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'Some tools require migrating to a new helpdesk interface. Others, like Resolv, connect directly to the Gmail address you already use for support, so there\'s no change to what your customers see.' },
      ...
      { type: 'p', text: 'Ask whether a quoted resolution percentage comes from live production traffic or a curated demo. Resolv publishes 86.5% as a live production figure specifically to make this checkable.' },
      { type: 'h3', id: 'trial-first', text: 'Trial before you commit' },
      { type: 'p', text: 'Because the real test is how a tool performs against your actual order data and your actual customers, a free trial with no credit card required is the most reliable way to evaluate any of these tools — including Resolv.' },
    ],
    faqs: [
    ...
    cta: { title: 'Evaluate Resolv against your own inbox.', sub: 'Start your 14-day free trial. No credit card required.' },
  },
